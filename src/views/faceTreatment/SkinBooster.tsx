...
export default function SkinBooster({ locale }: SkinBoosterProps) {
  return (
    <div className="w-full bg-light font-[--font-inter] overflow-hidden">
      ...
      {/* Quick Competitor Review Section - ALL text from pages 1-2 */}
      <motion.section
        variants={staggerContainer}
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-cream rounded-full blur-3xl" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <span className="text-wine">
              (what ranks on Google, and what most pages miss)
            </span>
          </motion.h2>
          ...
          >
            When people search "skin booster Kuala Lumpur" or "skin booster
            Malaysia", Google commonly shows:
          </motion.p>

          {/* 4 things Google shows - EXACT text */}
          <div className="grid md:grid-cols-2 gap-6 mb-16">
            <motion.div variants={scaleIn} className="bg-cream p-6 rounded-xl">
              <div className="flex items-start gap-3">
                <span className="bg-wine text-white w-6 h-6 rounded-full flex items-center justify-center text-sm shrink-0 mt-1">
                  1
                </span>
                <div>
                  ...
                  <p className="text-taupe">
                    Erufu Care tends to rank well because people want clinic
                    comparisons, reviews, and location filters.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={scaleIn} className="bg-cream p-6 rounded-xl">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-brown mb-2">
                    Clinic pages that explain basics and timeline
                  </h3>
                  <p className="text-taupe">
                    You will often see pages like Clinic Cleo and Dr K Clinic
                    because they answer common questions such as "How long does
                    it last?" and "How many sessions?"
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={scaleIn} className="bg-cream p-6 rounded-xl">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-taupe">
                    Price-focused pages get clicks because "cost in Malaysia" is
                    a top intent. You will see guides that list ranges for
                    Rejuran, Juvelook, and HA boosters.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div variants={scaleIn} className="bg-cream p-6 rounded-xl">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-brown mb-2">
                    KL specialist clinic pages
                  </h3>
                  <p className="text-taupe">
                    GLOJAS and similar clinics attract searches that include
                    "Kuala Lumpur" and "specialist".
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          {/* What competitor pages do not do well - EXACT text */}
          <motion.div variants={fadeInUp} className="mb-16">
            <h3 className="text-2xl font-semibold text-brown mb-6 text-center">
              What many competitor pages do not do well{" "}
              <span className="text-wine">
                (and what this Nexus page fixes)
              </span>
            </h3>

            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-linear-to-br from-orange-50 to-white p-6 rounded-xl border border-orange-100">
                <div className="flex items-start gap-3">
                  <AlertCircle className="w-5 h-5 text-orange-500 shrink-0 mt-1" />
                  <p className="text-brown">
                    They mention "glow", but they do not explain what changes
                    first (hydration) vs what takes longer (texture,
                    elasticity).
                  </p>
                </div>
              </div>
              ...
              <div className="bg-linear-to-br from-orange-50 to-white p-6 rounded-xl border border-orange-100">
                <div className="flex items-start gap-3">
                  <AlertCircle className="w-5 h-5 text-orange-500 shrink-0 mt-1" />
                  <p className="text-brown">
                    They give a price range, but skip what actually drives
                    price: product type, dosage, and session plan.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-linear-to-br from-orange-50 to-white p-6 rounded-xl border border-orange-100">
                <div className="flex items-start gap-3">
                  <AlertCircle className="w-5 h-5 text-orange-500 shrink-0 mt-1" />
                  <p className="text-brown">
                    They talk about many "brands", but don't help readers choose
                    based on skin concern (dryness, pores, acne marks, early
                    lines).
                  </p>
                </div>
              </div>
              ...
              <div className="bg-linear-to-br from-orange-50 to-white p-6 rounded-xl border border-orange-100">
                <div className="flex items-start gap-3">
                  <AlertCircle className="w-5 h-5 text-orange-500 shrink-0 mt-1" />
                  <p className="text-brown">
                    They rarely give a simple "day 1 to day 7" guide, which is
                    what anxious first-timers need most.
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* Day 1-7 Guide - exactly what anxious first-timers need */}
          <motion.div variants={fadeInUp} className="bg-cream p-8 rounded-2xl">
            <h4 className="text-xl font-semibold text-brown mb-6 flex items-center gap-2">
              <Calendar className="w-6 h-6 text-wine" />
              Your "Day 1 to Day 7" Guide (what anxious first-timers need most)
            </h4>

            <div className="grid grid-cols-7 gap-2 mb-4">
              {[1, 2, 3, 4, 5, 6, 7].map((day) => (
                <div key={day} className="text-center">
                  <div className="bg-wine text-white text-sm py-2 rounded-t-lg">
                    Day {day}
                  </div>
                  <div className="bg-white p-3 rounded-b-lg text-xs text-brown min-h-20">
                    {day === 1 &&
                      "Small bumps at injection points, mild redness or swelling"}
                    {day === 2 && "Redness and swelling begin to subside"}
                    {day === 3 && "Skin continues to calm, bumps reduce"}
                    {day === 4 && "First signs of hydration becoming visible"}
                    {day === 5 &&
                      "Skin looks more rested, glow starts to appear"}
                    {day === 6 && "Texture feels smoother under makeup"}
                    {day === 7 &&
                      "Noticeable improvement in hydration and glow"}
                  </div>
                </div>
              ))}
            </div>
