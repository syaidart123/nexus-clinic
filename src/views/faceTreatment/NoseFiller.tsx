...
export default function NoseFiller({ locale }: NoseFillerProps) {
  return (
    <div className="min-h-screen bg-light font-['Inter']">
      ...
      {/* What's ranking on Google - SEMUA KATA ADA */}
      <section className="py-20 bg-linear-to-b from-white to-cream">
        <motion.div
          variants={staggerContainer}
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          >
            <h2 className="text-4xl font-bold text-brown font-['Georgia'] mt-4 mb-6">
              What's ranking on Google right now
            </h2>
            <p className="text-xl text-taupe">
              (and what most competitors miss)
            </p>
          </motion.div>

          <motion.p variants={fadeInUp} className="text-brown text-center mb-8">
            When people search "nose filler Malaysia" or "non-surgical
            rhinoplasty Kuala Lumpur", the top results usually include:
          </motion.p>

          <div className="grid lg:grid-cols-2 gap-12 items-start mb-12">
            <motion.div variants={fadeInLeft} className="space-y-6">
              <div className="bg-white/70 backdrop-blur-md p-6 rounded-2xl border border-taupe/20">
                <h3 className="text-lg font-semibold text-wine mb-2">
                  Clinic directories
                </h3>
                <p className="text-brown">
                  that rank well due to authority and reviews, plus broad "price
                  and clinic list" content
                </p>
              </div>
              ...
              <div className="bg-white/70 backdrop-blur-md p-6 rounded-2xl border border-taupe/20">
                ...
                <p className="text-brown">
                  that explain cost factors, what it is, and basic expectations
                </p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-wine p-8 rounded-3xl text-white"
            >
              <h3 className="text-2xl font-bold mb-4">
                What's often missing is the stuff patients actually worry about
                late at night:
              </h3>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Clear "what it can't do" (for example, it cannot truly make
                    a nose smaller)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 mt-1 shrink-0" />
                  <span>
                    A simple safety section that explains rare but serious
                    complications and warning signs (not fear, just clarity)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 mt-1 shrink-0" />
                  <span>
                    Practical aftercare like glasses, sleeping position,
                    swelling timeline, and when to message the clinic
                  </span>
                </li>
              </ul>
            </motion.div>
          ...
          <motion.p
            variants={fadeInUp}
            className="text-center text-brown text-lg italic"
          >
            This page is written to cover those real questions in plain English.
          </motion.p>
        </motion.div>
      </section>
