...
export default function NoseThreadLift({ locale }: NoseThreadLiftProps) {
  return (
    <div className="bg-light font-inter overflow-x-hidden">
      ...
      {/* Quick competitor review section dengan semua teks */}
      <motion.section
        variants={staggerContainer}
        initial="hidden"
        whileInView="visible"
      ...
      >
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <span style={{ color: "var(--color-wine)" }}>
              (what shows up on Google and what most pages miss)
            </span>
          </motion.h2>
          ...
          >
            When people search "nose thread lift Kuala Lumpur" or "nose thread
            lift Malaysia", Google typically shows a mix of:
          </motion.p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            >
              <p
                ...
                style={{ color: "var(--color-wine)" }}
              >
                1. Clinic directory pages
              </p>
              <p style={{ color: "var(--color-brown)" }}>
                Erufu Care ranks strongly because it lists many KL clinics,
                reviews, and practical filters like location, doctor
                qualification, and price guidance.
              </p>
            </motion.div>
            ...
            >
              <p
                ...
                style={{ color: "var(--color-wine)" }}
              >
                2. Clinic pages focused on price and basic explanation
              </p>
              <p style={{ color: "var(--color-brown)" }}>
                Beverly Wilshire Clinic has a highly clickable page because it
                gives a clear Malaysia
              </p>
            </motion.div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              <p
                ...
                style={{ color: "var(--color-wine)" }}
              >
                3. Clinic pages that compare nose thread vs nose filler
              </p>
              <p style={{ color: "var(--color-brown)" }}>
                RJ Clinic ranks well for its side-by-side logic: which concern
                fits filler vs thread, plus a practical Malaysia price range.
              </p>
            </motion.div>
            ...
            >
              <p
                ...
                style={{ color: "var(--color-wine)" }}
              >
                4. Pages that answer FAQs in a snippet-friendly way
              </p>
              <p style={{ color: "var(--color-brown)" }}>
                Some clinics (example: Dr Soma Plastic Surgery) structure FAQs
                exactly the way Google's People Also Ask boxes like them.
              </p>
            </motion.div>
          </div>
          ...
          >
            <h3
              ...
              style={{ color: "var(--color-wine)" }}
            >
              Common gaps we see on many ranking pages (your advantage for Nexus
              Clinic KL):
            </h3>
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                />
                <span style={{ color: "var(--color-brown)" }}>
                  They say "non-surgical rhinoplasty," but don't explain what
                  threads can realistically change and what they cannot.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <AlertCircle
                ...
                />
                <span style={{ color: "var(--color-brown)" }}>
                  They mention safety, but don't explain how to spot normal
                  swelling vs warning signs.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <AlertCircle
                ...
                />
                <span style={{ color: "var(--color-brown)" }}>
                  They talk about threads, but skip the most important part:
                  nose anatomy limits (some noses simply cannot safely take many
                  threads). RJ Clinic hints at this, but most pages don't guide
                  patients clearly enough.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <AlertCircle
                ...
                />
                <span style={{ color: "var(--color-brown)" }}>
                  They do not give a calm, real timeline for "day 1 to day 14,"
                  which is what patients truly want before booking.
                </span>
              </li>
            </ul>
            <p
              ...
              style={{ color: "var(--color-wine)" }}
            >
              This page is written to close those gaps, while staying KL-focused
              and branded for Nexus Clinic Kuala Lumpur.
            </p>
          </motion.div>
        </div>
      </motion.section>
