        ...
        >
          <div className="max-w-4xl mx-auto">
            <motion.h2
              ...
              className="font-georgia text-4xl text-brown text-center mb-4"
            >
              Competitor Review (What Top Google Results in Malaysia Are Doing)
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="text-taupe text-center mb-8"
            >
              When you look at common high- visibility anti aging clinics in
              Malaysia and KL, patterns show up:
            </motion.p>

            <motion.div
              variants={fadeInUp}
              className="bg-light p-8 rounded-2xl mb-6"
            >
              <h3 className="font-georgia text-xl text-brown mb-3">
                They push non-surgical lifting tech hard
              </h3>
              <p className="text-taupe">
                Many highlight HIFU, Ultherapy, Thermage, and RF devices as the
                main answer for sagging and wrinkles.
              </p>
            </motion.div>
            ...
            >
              <h3 className="font-georgia text-xl text-brown mb-3">
                They highlight "MOH LCP certified doctor" positioning
              </h3>
              <p className="text-taupe">
                Several competitor pages emphasise that procedures should be
                done by registered doctors with the right credentials.
              </p>
            </motion.div>

            <motion.div
              variants={fadeInUp}
              className="bg-light p-8 rounded-2xl mb-8"
            >
              <h3 className="font-georgia text-xl text-brown mb-3">
                They list multi-treatment menus
              </h3>
              <p className="text-taupe">
                Example: one leading KL clinic page lists fractional CO2 laser,
                Thermage, RF microneedling, HIFU, and Ultherapy among wrinkle
                solutions.
              </p>
            </motion.div>
            ...
            <motion.div
              variants={fadeInUp}
              className="bg-wine/10 p-8 rounded-2xl"
            >
              ...
              <ul className="space-y-3 text-taupe">
                <li>
                  • Lead with "personalised program" and facial balance, not a
                  single device.
                </li>
                <li>• Show a clear pathway: protect, stimulate, reshape.</li>
                <li>
                  • Use conservative, natural results language (refreshed, not
                  frozen).
                </li>
                <li>• Make aftercare and maintenance transparent.</li>
              </ul>
            </motion.div>
          </div>
        </motion.div>
