        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Competitor review:{" "}
              <span className="text-wine">
                what's ranking for fat freezing in KL right now
              </span>
            </motion.h2>
            ...
            <motion.p
              ...
              className="text-brown/80 text-center mb-8"
            >
              When reviewing Google results for terms like "fat freezing Kuala
              Lumpur", "cryolipolysis KL", and "CoolSculpting Malaysia" (checked
              Feb 17, 2026), clinics and platforms that commonly appear include:
            </motion.p>
            ...
            >
              <div className="bg-white rounded-lg p-3 text-center text-brown shadow-sm">
                Clique Clinic (KL)
              </div>
              <div className="bg-white rounded-lg p-3 text-center text-brown shadow-sm">
                Premier Clinic
            ...
            <motion.div variants={fadeInUp} className="space-y-6">
              <div className="bg-white rounded-2xl p-6 shadow-lg">
                <h3 className="text-lg font-bold text-brown mb-3">
                  What competitors do well (and what we do better at Nexus
                  Clinic KL)
                </h3>
                <p className="font-medium text-wine mb-2">
                  Common strengths competitors use:
                </p>
                <ul className="space-y-2 text-brown/80 mb-4">
                  <li>
                    • Clear benefit statements and bold before-after language
                  </li>
                  <li>• Cost ranges and "from price" hooks</li>
                  <li>• Location targeting across KL suburbs</li>
                  <li>• FAQ-heavy pages that match real search questions</li>
                </ul>

                <p className="font-medium text-wine mb-2">
                  Nexus Clinic advantage you should lean into:
                </p>
                <ul className="space-y-2 text-brown/80">
                  <li>
                    • Transparent published pricing examples (like per
                    applicator)
                  </li>
                  <li>
                    • Strong "doctor-led" positioning and suitability screening
                  </li>
                  <li>
                    • Better expectation setting: contouring results, not
                    miracle weight loss
                  </li>
                </ul>

                <p className="mt-4 text-brown font-medium">
                  If your goal is to rank, the content should also show
                  expertise and safety, not only marketing.
                </p>
              </div>
            </motion.div>
          </motion.div>
