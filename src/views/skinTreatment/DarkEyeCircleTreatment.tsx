      ...
      >
        <div className="max-w-7xl mx-auto">
          <motion.h2
            ...
            className="text-4xl md:text-5xl font-georgia text-brown text-center mb-4"
          >
            Competitor snapshot (what's ranking and what they emphasize)
          </motion.h2>

          <motion.p
            variants={fadeInUp}
            className="text-center text-lg text-taupe mb-12"
          >
            Exact rankings change by location, device, and search history. But
            these providers commonly appear in Google results for dark circles
            in KL, and each emphasizes a different angle:
          </motion.p>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            <motion.div variants={scaleIn} className="bg-cream rounded-xl p-6">
              <p className="font-bold text-xl text-brown mb-2">
                Clique Clinic (KL)
              </p>
              <p className="text-taupe">
                focuses on personalized dark circle and eye bag treatment and
                includes FAQ style questions such as creams and cost.
              </p>
            </motion.div>
            <motion.div variants={scaleIn} className="bg-cream rounded-xl p-6">
              <p className="font-bold text-xl text-brown mb-2">
              ...
              <p className="text-taupe">
                publishes educational content on causes and treatments,
                including laser options like Pico Laser and dual yellow light
                laser therapy.
              </p>
            </motion.div>
            <motion.div variants={scaleIn} className="bg-cream rounded-xl p-6">
              ...
              <p className="text-taupe">
                presents a menu of device-based options such as Pro Yellow Laser
                and PicoSure for dark circles.
              </p>
            </motion.div>
            <motion.div variants={scaleIn} className="bg-cream rounded-xl p-6">
              <p className="font-bold text-xl text-brown mb-2">
              ...
              <p className="text-taupe">
                lists multiple injectable and eye rejuvenation options for dark
                circles and eye bags.
              </p>
            </motion.div>
            <motion.div variants={scaleIn} className="bg-cream rounded-xl p-6">
              <p className="font-bold text-xl text-brown mb-2">Clinic Cleo</p>
              <p className="text-taupe">
                publishes educational content around under-eye concerns and
                treatment approaches.
              </p>
            </motion.div>
            <motion.div variants={scaleIn} className="bg-cream rounded-xl p-6">
              <p className="font-bold text-xl text-brown mb-2">Erufu Care</p>
              <p className="text-taupe">
                directories rank and list many clinics, with reviews and "price
                guide" positioning, which can influence patient choice in
                Malaysia.
              </p>
            </motion.div>
          </div>
          ...
          <motion.div
            variants={fadeInUp}
            className="bg-wine/5 border-2 border-wine/20 rounded-2xl p-8"
          >
            <h3 className="text-2xl font-georgia text-brown mb-3">
              How Nexus Clinic KL can win the click
            </h3>
            <p className="text-xl text-taupe">
              Lead with diagnosis-first clarity and under-eye safety. Nexus
              already differentiates with doctor-led tear trough planning and
